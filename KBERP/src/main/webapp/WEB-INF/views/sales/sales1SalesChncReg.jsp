...
$(document).ready(function() {
	...
	// 저장 버튼 누르면 영업기회 상세보기로 이동하도록. **필수항목체크 추가하기**
					...
					<table>
						...
						<tbody>
							<tr>
								...
								<td colspan="3"><input type="text" class="txt" readonly="readonly" value="${ln.LEAD_NAME}" /></td>
							</tr>
							<tr height="40">
									<td><input type="button" class="btn" value="고객사"/></td>
									<td colspan="3"><input type="text" class="txt" readonly="readonly" value="${ln.CLNT_CMPNY_NAME}" /></td>								
							</tr>
							<tr height="40">
									<td><input type="button" class="btn" value="고객" /></td>
									<td colspan="3"><input type="text" class="txt" readonly="readonly" value="${ln.CLNT_NAME}" /></td>
							</tr>
							<tr height="40">
									<td><input type="button" class="btn" value="고객사 등급"/></td>
									<td colspan="3"><input type="text" class="txt" readonly="readonly" value="${ln.GRADE_NAME}" /></td>		
							</tr>
							<tr height="40">
									<td><input type="button" class="btn" value="영업시작일*" /></td>
									<td colspan="3"><input type="date" class="txt" readonly="readonly" value="${tday}"/></td>
							<tr height="40">
								<td><input type="button" class="btn" value="담당자 *" readonly="readonly" /></td>
								<td colspan="3">
									<input type="text" class="txt" id="mngrName" name="mngrName" value="${ln.EMP_NAME}" />
					...
					<table>
						...
						<tbody>
							...
							<tr height="40">
									...
									<td colspan="3"><input type="text" class="txt" id="expctnLoanScale" name="expctnLoanScale" /></td>								
							</tr>
							<tr height="40">
					...
					<table>
						...
						<tbody>
							<tr height="40">
									...
									<td colspan="3"><input type="text" class="txt" id="expctdBsnsName" name="expctdBsnsName" /></td>
							</tr>
							<tr height="40">
									<td><input type="button" class="btn" value="예정 사업 형태" /></td>
									<td colspan="3"><input type="text" class="txt" id="expctdBsnsType" name="expctdBsnsType" /></td>
							</tr>
							<tr height="40">
									<td><input type="button" class="btn" value="비고" /></td>
									<td colspan="3"><input type="text" class="rmks" id="rmks" name="rmks" /></td>
							</tr>
						</tbody>
					</table>
					<br/>
