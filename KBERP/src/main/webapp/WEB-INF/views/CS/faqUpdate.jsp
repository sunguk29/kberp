...
<body>
	...
	<input type="hidden" id="menuType" name="menuType" value="${param.menuType}"/>
				<div class="cate">
					...
					<div class="wrt_title">
						<input type="text" placeholder="제목(질문글)" id="title" name="title" value="${data.WRTNG_TITLE}">
					</div>
					
			<div class="middle">
				<textarea class="cont" id="cont" name="cont" rows="30" cols="114">${data.WRTNG_CONT}</textarea>
			</div>
